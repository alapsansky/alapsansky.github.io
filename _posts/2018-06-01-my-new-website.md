...
This website is made using Jekyll pages and hosted using GitHub. Jekyll is an impressively powerful site generator. Given a few template details, Jekyll will build a website and properly organize blog posts
and other content with minimal effort. The actual text is written in kramdown `{:...}`. Below are some examples of what I can do (these are mainly for my own benefit - i.e., for future copy-pasting.)
...
## Large images
![Full-width image](http://placehold.it/800x100){:.lead data-width="800" data-height="100"}
